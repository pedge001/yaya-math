...
export default function EnterInitialsSpeedScreen() {
  ...
  const handleSubmit = async () => {
    ...
    const result = await retryWithBackoff(
      () =>
        submitTimeMutation.mutateAsync({
        ...
        }),
      {
        ...
        onRetry: (attempt, delay, error) => {
          console.log(`Speed mode retry attempt ${attempt} after ${delay}ms due to:`, error);
    ...
    if (result.success && result.data) {
      ...
      if (submissionResult.success) {
        ...
        await addSubmissionToHistory({
          initials: initials.join(""),
          score: total, // for speed mode, score = total problems completed
          totalProblems: total,
          operation: operation,
          difficulty: difficulty,
          mode: "speed",
      ...
      let errorMessage = "Unable to submit your time. Please check your connection and try again.";
      ...
      <View className="flex-1 justify-center items-center">
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            opacity: submitTimeMutation.isPending ? 0.5 : 1,
          }}
          disabled={submitTimeMutation.isPending}
        >
          {submitTimeMutation.isPending ? (
